...
### 🌐 Subdomain Gathering
We query public search databases using [Subfinder]({{ '/tools/subdomain-dns/subfinder/' | relative_url }}) and [OWASP Amass]({{ '/tools/subdomain-dns/amass/' | relative_url }}):
...
Once the list is gathered, we sweep for open TCP ports using [Naabu]({{ '/tools/recon-osint/naabu/' | relative_url }}):
